...
<body id="page-top">
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-top">
                        <h3 class="text-uppercase text-white font-weight-bold">선생님 회원가입</h3>
	<form:form  modelAttribute="memberInfo" enctype="multipart/form-data" >
		...
		<div class="row align-items-center justify-content-center">
				<div class="col-xs-6 text-right pr-3">
			<form:label class="text-white-75 font-weight-light mb-0" path="t_email" maxlength="20">이메일</form:label>
			</div>
				<div class="col-xs-6 text-left">
			<form:input path="t_email" onkeydown="eCheck()" /><br>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-9 text-right">
			<small><form:errors path="t_email" class="text-white-75 font-weight-light mb-2" /></small>
			</div>
			</div>
		</p>
		...
		<div class="row align-items-center justify-content-center">
				<div class="col-xs-6 text-right pr-3">
			<form:label class="text-white-75 font-weight-light mb-0" path="t_phone" maxlength="20">전화번호</form:label>
			</div>
				<div class="col-xs-6 text-left">
			<form:input path="t_phone" onkeydown="pCheck()" pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}" /><br>
				</div>
			</div>
			<div class="row">
				<div class="col-xs-9 text-right">
			<small><form:errors path="t_phone" class="text-white-75 font-weight-light mb-2" /></small>
			</div>
			</div>
		</p>
